...
begin
  ...
  try
    ...
    Grammar := Context1.CreateGrammar;
...
begin
  ...
  begin
   ...
   // SpInProcRecognizer1.Recognizer := SpInProcRecognizer1.GetRecognizers('','').Item(cbbRecognizers.ItemIndex);
   // context1.Recognizer.Recognizer := SpInProcRecognizer1.GetRecognizers('','').Item(cbbRecognizers.ItemIndex);
  end;
end;
